...
procedure TF_A14.UpData;
begin
  D.F25.Locate('BEF25001', VarArrayOf([SG01.Cells[0,SG01.Row]]), [loCaseInsensitive]);
   E_001.TEXT := D.F25.FieldByName('BEF25001').ASSTRING;
   E_099.TEXT := D.F25.FieldByName('BEF25099').ASSTRING;
end;

procedure TF_A14.SG01Snd;
var
  i : integer;
begin
  KC_SGClear(1,SG01);
  ...
  Begin
    SG01.Cells[0,i] := D.F25.FieldByName('BEF25001').ASSTRING;
    SG01.Cells[1,i] := D.F25.FieldByName('BEF25099').ASSTRING;
    inc(i);
    D.F25.Next;
  End;
...
procedure TF_A14.C_Kind(CC_Kind : Byte);  // 0:Append 1.Modify  2.View
Begin
  Kind := CC_Kind;
  case Kind of
    0 : begin
          ...
          TbStpEdit(True,F_A14,['TEdit','TComboBox','TRichEdit']);
          SB_Append.Down := True;
        end;
    1 : Begin
    ...
    2 : Begin
          L_Kind.Caption := 'View';
          P_Main.color:= clBtnFace;
          TbStpEdit(False,F_A14,['TEdit','TComboBox','TRichEdit']);
          SB_Inquire.Down := True;
        End;
    End;
End;

procedure TF_A14.F_Save;
begin
  if (2 = kind) Then Exit;
  ...
  D.F25.FieldByName('BEF25001').ASSTRING :=  E_001.TEXT;
  D.F25.FieldByName('BEF25099').ASSTRING :=  E_099.TEXT;
  D.F25.ApplyUpdates(-1);
  D.OpenF25;
  SG01ini;
  SG01Snd;
  Updata;
...
procedure TF_A14.FormShow(Sender: TObject);
begin
...
procedure TF_A14.SB_InquireClick(Sender: TObject);
begin
...
procedure TF_A14.SG01KeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TF_A14.SG01MouseUp(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
  UpData;
end;
