...
uses
  ...
  Dialogs, ExtCtrls, Grids, CIM_Grid, StdCtrls, DB;
...
procedure TF_C10.OpenG19;
var
  SQL : String;
begin
  SQL := 'SELECT * FROM BEFG19 With (INDEX(BEFG19_101)) Where BEF19101 = ''3'' and BEF19013 <> '''' Order by BEF19010,BEF19011';
...
procedure TF_C10.UPData(TSG : TCIM_Grid);
begin
  L_010.Caption := TSG.Cells[00,TSG.Row];
 CB_013.Text    := TSG.Cells[01,TSG.Row];
end;

procedure TF_C10.SG02MouseUp(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
  UPData(TCIM_Grid(Sender));
end;

procedure TF_C10.SG02KeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TF_C10.B_SaveClick(Sender: TObject);
var
  i : integer;
  S,SQL : String;
begin
...
procedure TF_C10.FormShow(Sender: TObject);
begin
  D.OpenF05;
  D.OpenF22;
  OpenG19;
